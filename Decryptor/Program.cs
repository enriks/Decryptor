...
namespace Decryptor
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<string> DecriptedList = Tools.counter(part1,part2,part3,texto1,texto2,texto3,partkey);//usa el contador para obtener todas las combinaciones y el resultado de intentar desencriptarlas
            Tools.CreateFile(DecriptedList, "decriptedfile1");//crea el archivo con los resultados
            Console.ReadLine();
